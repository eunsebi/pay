...
<!-- 비번변경모달 -->
			...
			<table border="0">
				...
				<tr>
					<td colspan="4">
						...
						<input type="hidden" class="input input-rect" id="endtime" name="endtime" style="width: 192px" placeholder="종료일" readonly="readonly"/>
	...
	<div class="panel main-container">
		<div class="head">
			<i class="icon-home"></i>급여 관리 시스템(&nbsp;<span id="head-year"></span>년&nbsp;<span id="head-month"></span>월&nbsp;<span id="head-day"></span>일&nbsp;<span id="head-hour"></span>시&nbsp;<span id="head-min"></span>분&nbsp;)
